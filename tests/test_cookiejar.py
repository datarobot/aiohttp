...
class HeaderTests(unittest.TestCase):
    ...
    def test_split_header_words(self):
        ...
        for arg, expect in tests:
            ...
            self.assertEqual(result, expect, dedent(
                r"""\
                When parsing: '%s'
                Expected:     '%s'
                Got:          '%s'
...
class LWPCookieTests(unittest.TestCase):
    ...
    def test_netscape_example_2(self):
        ...
        #   the inheritance of the "/" mapping
    ...
    def test_ietf_example_1(self):
        # Then we test with the examples from
        ...
        #
        # The user agent makes a series of requests on the origin
        # server, after each of which it receives a new cookie.  All
        # the cookies have the same Path attribute and (default)
        # domain.  Because the request URLs all have /acme as a
        # prefix, and that matches the Path attribute, each request
    ...
    def test_ietf_example_2(self):
        ...
        # A subsequent request by the user agent to the (same) server
        ...
        # specific Path attribute, /acme/ammo, comes before the one
        # with the less specific Path attribute, /acme.  Further note
        ...
        # prefix of the request URL, /acme/parts/, so the cookie does
        # not get forwarded to the server.
